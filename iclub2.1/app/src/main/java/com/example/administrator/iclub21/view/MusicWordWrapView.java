 ...
 */
public class MusicWordWrapView extends ViewGroup {
    private static final int PADDING_HOR = 5;//水平方向padding
    private static final int PADDING_VERTICAL = 5;//垂直方向padding
    private static final int SIDE_MARGIN = 80;//左右间距
    private static final int TEXT_MARGIN = 10;
    /**
     * @param context
     */
    public MusicWordWrapView(Context context) {
        super(context);
    }
     ...
     * @param defStyle
     */
    public MusicWordWrapView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * @param attrs
     */
    public MusicWordWrapView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
