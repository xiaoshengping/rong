 ...
 */
public class ResumeDeleteVideoAdapter extends AppBaseAdapter<ResumeMovie> {
    private ViewHodle viewHodle;

    public ResumeDeleteVideoAdapter(List<ResumeMovie> data, Context context) {
        super(data, context);
    }
    ...
    public View createView(int position, View convertView, ViewGroup parent) {
        if (convertView==null){
            convertView= LayoutInflater.from(context).inflate(R.layout.resume_delete_video_layout,null);
